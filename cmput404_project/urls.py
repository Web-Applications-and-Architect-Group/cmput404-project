...
urlpatterns = [
    ...
    url(r'^posts/(?P<post_id>[a-zA-Z0-9-_]+)$',
        api.Post_Detail.as_view(),name='a_single_post_detail'),     # Allow [GET, POST]. GET Done #TODO:POST
    ...
    # Friend API
    # """
    url(r'^author/(?P<author_id>[a-zA-Z0-9-_]+)/friends/$',         # Allow [GET, POST]. GET, POST Done
        api.Friend_Inquiry_Handler.as_view(), name='friend_inquiry'),
    url(r'^author/(?P<author_id1>[a-zA-Z0-9-_]+)/friends/(?P<author_id2>[a-zA-Z0-9-_]+)$',
