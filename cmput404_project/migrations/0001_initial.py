    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[(b'text/plain', b'text/plain'), (b'text/markdown', b'text/markdown'), (b'application/base64', b'application/base64'), (b'image/png;base64', b'image/png;base64'), (b'image/jpeg;base64', b'image/jpeg;base64'), (b'github-activity', b'github-activity')], default=b'PUBLIC', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(default=uuid.uuid4, max_length=100, primary_key=True, serialize=False)),
                ('visibility', models.CharField(choices=[(b'PUBLIC', b'PUBLIC'), (b'FOAF', b'FOAF'), (b'FRIENDS', b'FRIENDS'), (b'PRIVATE', b'PRIVATE'), (b'SERVERONLY', b'SERVERONLY')], default=b'text/plain', max_length=20)),
                ('contentType', models.CharField(choices=[(b'text/plain', b'text/plain'), (b'text/markdown', b'text/markdown'), (b'application/base64', b'application/base64'), (b'image/png;base64', b'image/png;base64'), (b'image/jpeg;base64', b'image/jpeg;base64'), (b'github-activity', b'github-activity')], default=b'PUBLIC', max_length=20)),
                ...
                ('temp', models.BooleanField(default=False)),
                ('visibleTo', models.CharField(max_length=100)),
